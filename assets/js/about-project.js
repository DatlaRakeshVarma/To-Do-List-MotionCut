    ...
    aboutProjectSection.innerHTML = `
        <div class="modal_container">
            ...
            <footer class="form_footer" id="about_project_footer">
                <p id="last_update"></p>
                <a href="https://github.com/DatlaRakeshVarma/To-Do-List-MotionCut" target="_blank" rel="noopener noreferrer">Visit Github for more info.</a>
            </footer>
        </div>
    `;
    
    fetch("https://api.github.com/repos/DatlaRakeshVarma/To-Do-List-MotionCut")
